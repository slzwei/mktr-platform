/**
 * rsvp_layout v1 — FRONTEND MIRROR of backend/src/utils/rsvpLayout.js.
 *
 * The backend file is the SOURCE OF TRUTH; this mirror exists so the designer
 * and the public renderer can clamp/preview without importing across the
 * package boundary. src/lib/__tests__/rsvpLayout.lockstep.test.js imports BOTH
 * and fails the build on any divergence. Edit them together, backend first.
 *
