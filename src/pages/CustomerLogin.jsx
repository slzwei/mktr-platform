    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        ...
        <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-10">
          <h1 className="text-2xl font-bold text-black dark:text-white" style={{ fontFamily: 'var(--heading-font)' }}>
            MKTR.
          </h1>
        </div>
            ...
            <Card className="shadow-xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">New to MKTR?</p>
                  <Link to={'/Contact'}>
