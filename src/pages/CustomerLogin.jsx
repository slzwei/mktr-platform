...
export default function CustomerLogin() {
 ...
 <div className="w-16 h-16 bg-info/15 text-primary rounded-full mx-auto mb-4 flex items-center justify-center">
 <Users className="w-8 h-8"/>
 </div>
 <h2 className="font-semibold text-foreground mb-2">Sales Agent Portal</h2>
 ...
 <Input
 id="agent-email" name="email" type="email" autoComplete="username" value={formData.email}
 ...
 <div className="space-y-2">
 <label
 htmlFor="agent-password" className="text-sm font-medium text-foreground" >
 Password
 </label>
 <Input
 id="agent-password" name="password" type="password" autoComplete="current-password" value={formData.password}
 onChange={handleChange}
 ...
 className="w-full bg-primary hover:bg-primary/90 text-background" size="lg" >
 {loading ? (
 'Signing In...'
 ) : (
 <>
 ...
 <path
 fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
 <path
 fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
 <path
 fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
 <path
 fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
 </svg>
 Sign in with Google
 </Button>
 </form>
 ...
 <div className="text-center py-4">
 <div className="w-16 h-16 bg-success/15 text-success rounded-full mx-auto mb-4 flex items-center justify-center">
 <Car className="w-8 h-8"/>
 </div>
 <h2 className="font-semibold text-foreground mb-2">Fleet Owner Portal</h2>
 <p className="text-sm text-muted-foreground mb-6">
 ...
 <form onSubmit={handleSubmit} className="space-y-4 text-left">
 <div className="space-y-2">
 <label htmlFor="fleet-email" className="text-sm font-medium text-foreground">
 Email
 </label>
 <Input
 id="fleet-email" name="email" type="email" autoComplete="username" value={formData.email}
 onChange={handleChange}
 placeholder="Enter your email" required
 />
 </div>
 ...
 <div className="space-y-2">
 <label
 htmlFor="fleet-password" className="text-sm font-medium text-foreground" >
 Password
 </label>
 <Input
 id="fleet-password" name="password" type="password" autoComplete="current-password" value={formData.password}
 onChange={handleChange}
 placeholder="Enter your password" required
 />
 </div>
 ...
 <Button
 type="submit" disabled={loading}
 className="w-full bg-success hover:bg-success/90 text-background" size="lg" >
 {loading ? (
 'Signing In...'
 ) : (
 <>
