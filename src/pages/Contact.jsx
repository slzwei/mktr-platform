...
"There was an issue sending your message. Please try again later." );
 ...
 <h1
 className="mktr-hero-title mktr-reveal mktr-reveal-delay-1" style={{ marginBottom:"1.5rem"}}
 >
 ...
 >
 <CheckCircle
 className="w-16 h-16 mx-auto mb-4" style={{ color:"var(--mktr-accent)"}}
 />
 <h2
 style={{
 ...
 onChange={handleChange}
 placeholder="+65 8123 4567" style={inputStyle}
 />
 </div>
 </div>
 ...
 minLength={10}
 rows={5}
 placeholder="Tell us about your needs..." style={inputStyle}
 />
 {error && (
 <p
 style={{
 ...
 <a
 href="https://wa.me/6580790542" target="_blank" rel="noopener noreferrer" className="mktr-hero-cta-secondary" style={{ fontSize:"0.9rem", padding:"0.75rem 1.5rem"}}
 >
 +65 8079 0542
 </a>
 </div>
