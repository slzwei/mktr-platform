...
export default function DriverDashboard() {
 ...
 user={user}
 greeting
 roleBadge="Driver Partner" period={period}
 ...
 <Line type="monotone" dataKey="count" stroke="hsl(var(--chart-1))" strokeWidth={3} dot={{ r: 3 }} activeDot={{ r: 5 }} />
 </LineChart>
 </ResponsiveContainer>
 </div>
 </CardContent>
 ...
 <Line type="monotone" dataKey="amount" stroke="hsl(var(--chart-2))" strokeWidth={3} dot={{ r: 3 }} activeDot={{ r: 5 }} />
 </LineChart>
 </ResponsiveContainer>
 </div>
 </CardContent>
 ...
 userRole="driver_partner" period={period}
