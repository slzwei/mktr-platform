...
export default function GoogleCallback() {
 ...
 <CardTitle className="text-2xl font-bold text-foreground mb-2">Google Authentication</CardTitle>
 </CardHeader>
 <CardContent className="text-center space-y-4">
 {status === 'success' && (
 <>
 <div className="w-16 h-16 bg-success/15 text-success rounded-full mx-auto flex items-center justify-center">
 ...
 {status === 'error' && (
 <>
 <div className="w-16 h-16 bg-destructive/15 text-destructive rounded-full mx-auto flex items-center justify-center">
