...
export default function ProvisionDevice() {
 ...
 <Card className="w-full max-w-md border-success/30 bg-success/10">
 <CardContent className="pt-6 text-center">
 <CheckCircle2 className="mx-auto h-12 w-12 text-success mb-4"/>
 <h2 className="text-2xl font-bold text-success mb-2">Provisioning Successful!</h2>
 <p className="text-success">The tablet should automatically log in now.</p>
 </CardContent>
 </Card>
 </div>
 </DashboardLayout>
 ...
 <Input
 placeholder="e.g. tablet-123-sec-key" value={deviceKey}
 ...
 <Button type="submit" className="w-full" disabled={submitting || !deviceKey.trim()}>
 {submitting ? (
 <>
