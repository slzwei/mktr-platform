...
const AdminApkManager = () => {
 ...
 <div className="mb-8">
 <h1 className="text-3xl font-bold tracking-tight text-foreground">App Versions</h1>
 <p className="text-muted-foreground mt-2">
 Manage the Android application package (APK) for the fleet.
 </p>
 </div>
 ...
 <CardDescription>
 The version currently being served at{' '}
 ...
 <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-4 bg-muted rounded-lg border border-border">
 <div className="space-y-1">
 <div className="flex items-center gap-2">
 <span className="font-semibold text-foreground">{currentApk.filename}</span>
 ...
 <div className="flex flex-col items-center justify-center py-8 text-muted-foreground bg-muted rounded-lg border border-dashed border-border">
 ...
 <CardDescription className="text-primary/80/80">
 ...
 <Input id="apk-upload" type="file" accept=".apk" onChange={handleFileChange} disabled={isUploading} />
 <p className="text-xs text-muted-foreground">Only .apk files are allowed. Max size 200MB.</p>
 </div>

 {selectedFile && (
 <div className="mb-4 p-3 bg-muted rounded text-sm text-foreground flex items-center justify-between">
 <span>
