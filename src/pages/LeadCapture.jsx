...
export default function LeadCapture() {
 ...
 <h2 className="text-2xl font-bold text-foreground tracking-tight">Success!</h2>
 <p className="text-muted-foreground mt-2 mb-6">Your details have been received securely.</p>
 ...
 <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-destructive/15 mb-4 animate-in zoom-in duration-300">
 ...
 <div className="mt-6">
 <p className="text-xs text-muted-foreground mb-2">Redirecting in {duplicateCountdown}s...</p>
 ...
 <p className="text-xs text-muted-foreground mt-4 animate-pulse">Loading secure experience...</p>
 </div>
 )}
