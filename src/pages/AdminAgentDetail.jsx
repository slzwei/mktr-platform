    ...
    <div className="p-6 lg:p-8 min-h-screen bg-gray-50/50 dark:bg-gray-900/50">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div>
          <Link
            to="/AdminAgents"
            className="inline-flex items-center text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mb-4 transition-colors"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100 flex items-center gap-3">
                ...
                <Badge
                  variant="outline"
                  className="font-normal text-sm bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400"
                >
                  ID: {agent.id.slice(-8)}
                </Badge>
              </h1>
                    ...
                    prospects.map((prospect) => (
                      ...
                      >
                        ...
                        <TableCell className="px-6 py-4">
                          <Badge
                            variant="outline"
                            className={statusStyles[prospect.leadStatus] || 'bg-gray-100 dark:bg-gray-700'}
                          >
