                ...
                <div className="space-y-4">
                  {stats.cars.slice(0, 5).map((car) => (
                    <div key={car.id} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                      ...
                      <Badge className={
                        car.status === "active" ? "bg-green-100 text-green-800 dark:bg-green-950/30 dark:text-green-400" :
                        car.status === "maintenance" ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-950/30 dark:text-yellow-400" :
