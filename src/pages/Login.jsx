...
export default function CustomerLogin() {
 ...
 {error && (
 <div className="flex items-center gap-2 p-3 bg-destructive/10 text-destructive rounded-lg border border-destructive/30">
 ...
 className="w-full bg-foreground text-background hover:bg-foreground" size="lg" >
