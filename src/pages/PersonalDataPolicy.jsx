...
"Government authorities when required by law.",
 ...
 list: [
"Hashed (SHA-256) contact information — email address and phone number. For signups made from 21 July 2026, this transmission is part of the single agreement you accept when claiming an offer (submitting a form is not possible without it). For older signups it applies only where the marketing-consent checkbox — optional at the time — was left ticked.",
