...
export default function AuthTest() {
 ...
 <div className="mb-6">
 <h1 className="text-3xl font-bold text-foreground mb-2">Authentication System Test</h1>
 <p className="text-muted-foreground">Testing MKTR authentication system with Google OAuth</p>
 </div>
