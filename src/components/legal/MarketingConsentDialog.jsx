...
export default function MarketingConsentDialog({ open, onOpenChange, content }) {
 ...
 <div className="space-y-4 text-sm text-foreground leading-6 pr-1">
 {sanitizedContent ? (
 ...
 <a href="https://mktr.sg/personal-data-policy" target="_blank" rel="noreferrer" className="text-primary hover:underline">https://mktr.sg/personal-data-policy</a>
 ).
 </p>
 <p>
