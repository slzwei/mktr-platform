...
export default function AssignDriverDialog({ 
 ...
 <p className="text-sm text-info mb-2">Currently Assigned To:</p>
 <div className="flex items-center gap-3">
 <Avatar className="w-8 h-8">
 <AvatarFallback className="bg-info/15 text-primary">
 ...
 <span className="text-muted-foreground">Unassign current driver</span>
 </SelectItem>
 )}
