...
export default function FleetOwnerFormDialog({
 ...
 <Input
 id="full_name" placeholder="Fleet owner's full name" {...register("full_name")}
 />
 {errors.full_name && (
 ...
 <Input
 id="email" type="email" placeholder="owner@company.com" {...register("email")}
 />
 {errors.email && (
 ...
 <Input
 id="phone" placeholder="+65 XXXX XXXX" {...register("phone")}
 />
 {errors.phone && (
 ...
 <Input
 id="company_name" placeholder="Company name (optional)" {...register("company_name")}
 />
 {errors.company_name && (
 <p className="text-destructive text-xs mt-1">{errors.company_name.message}</p>
 )}
 </div>
 </div>
 ...
 <Input
 id="uen" placeholder="Unique Entity Number (optional)" {...register("uen")}
 />
 {errors.uen && (
 <p className="text-destructive text-xs mt-1">{errors.uen.message}</p>
 )}
 </div>
 ...
 <Controller
 name="payout_method" control={control}
 render={({ field }) => (
 ...
 <p className="text-destructive text-xs mt-1">{errors.payout_method.message}</p>
 )}
 </div>
 </div>
