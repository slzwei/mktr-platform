...
export default function CarFormDialog({
 ...
 >
 <Input
 name="plate_number" value={formData.plate_number}
 onChange={handleChange}
 placeholder="e.g., SGP1234A" required
 className={fieldErrors.plate_number ? 'border-destructive focus-visible:ring-destructive/30' : ''}
 />
 </FormRow>
 ...
 <SubmitButton
 pending={loading}
 pendingText="Saving..." className="bg-primary hover:bg-primary/90" >
