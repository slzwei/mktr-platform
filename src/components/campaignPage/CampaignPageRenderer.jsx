...
import { formatDrawDate, deriveCampaignPageContent } from './shared';
...
// Shared chrome/helpers moved to ./shared (P4-7) — re-exported so existing
// importers (StudioTopBar, tests) keep their path.
export { formatDrawDate, deriveCampaignPageContent, BrandFooter, DrawBadge, ReferredBadge } from './shared';

// With templates/drawTemplates importing ./shared (not this file), the cycle
// is gone and the registries can merge at module scope.
const ALL_TEMPLATES = { ...TEMPLATES, ...DRAW_TEMPLATES };
...
export default function CampaignPageRenderer({
  ...
  const Template = ALL_TEMPLATES[templateId] || TEMPLATES.editorial;
