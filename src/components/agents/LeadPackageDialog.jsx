...
export default function LeadPackageDialog({ open, onOpenChange, agent, onSubmit }) {
 ...
 <Controller
 name="campaign_id" control={control}
 render={({ field }) => (
 ...
 />
 {errors.campaign_id && (
 <p className="text-destructive text-xs mt-1">{errors.campaign_id.message}</p>
 )}
 </div>
 ...
 <Input
 id="package_name" placeholder="e.g., Starter Package, Premium Package" {...register("package_name")}
 />
 {errors.package_name && (
 <p className="text-destructive text-xs mt-1">{errors.package_name.message}</p>
 )}
 </div>
 ...
 <Input
 id="total_leads" type="number" min="1" placeholder="100" {...register("total_leads")}
 />
 {errors.total_leads && (
 <p className="text-destructive text-xs mt-1">{errors.total_leads.message}</p>
 )}
 </div>
 <div>
 <Label htmlFor="price_per_lead">Price per Lead (SGD) *</Label>
 <Input
 id="price_per_lead" type="number" min="0" step="0.01" placeholder="20.00" {...register("price_per_lead")}
 />
 {errors.price_per_lead && (
 <p className="text-destructive text-xs mt-1">{errors.price_per_lead.message}</p>
 )}
 </div>
 </div>
 ...
 <Input
 id="start_date" type="date" {...register("start_date")}
 />
 </div>
 <div>
 <Label htmlFor="end_date">End Date</Label>
 <Input
 id="end_date" type="date" {...register("end_date")}
 />
 </div>
 </div>
 ...
 <Textarea
 id="notes" placeholder="Additional notes about this package..." rows={3}
 {...register("notes")}
 />
 </div>
