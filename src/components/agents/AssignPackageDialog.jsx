...
const AssignPackageDialog = ({ open, onOpenChange, agent, onSubmitSuccess }) => {
 ...
 <span className="font-medium text-success">${selectedPackage.price}</span>
 </div>
 ...
 <Button type="submit" disabled={loading || !selectedPackageId} className="bg-primary hover:bg-primary/90">
