      ...
      return (
        <div key={fieldId} className="space-y-1.5">
          ...
          <div className="flex items-center gap-2">
            <div
              className="flex-grow flex shadow-sm rounded-xl overflow-hidden active-ring focus-within:ring-2 focus-within:ring-offset-0 transition-all"
              style={{ '--tw-ring-color': themeColor + '33' }}
            >
    ...
    case 'education_level':
      return (
        <div key={fieldId} className="space-y-1.5">
          ...
          >
            <SelectTrigger
              className="h-11 text-base bg-gray-50/50 border-gray-200 focus:ring-2 focus:ring-offset-0 rounded-xl"
              style={{ '--tw-ring-color': themeColor + '33' }}
            >
