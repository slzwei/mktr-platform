...
export default function PreviewFrame({ currentDesign, campaign, onDesignChange }) {
 ...
 <span className="text-sm font-medium text-foreground">Interactive Preview</span>
 </div>
 ...
 <div className="flex-1 bg-muted rounded text-[10px] text-muted-foreground text-center py-1 mx-4">
 ...
 {/* Content Card */}
 <div
 className={`w-full max-w-[375px] ${getCardClass(currentDesign)} transform transition-colors duration-300`}
