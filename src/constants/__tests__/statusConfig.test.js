...
describe('getStatusColor', () => {
  ...
  it('returns a default gray style for an unknown status', () => {
    const fallback = getStatusColor('totally_unknown');
    expect(fallback).toMatch(/bg-gray/);
    expect(fallback).toMatch(/text-gray/);
  });

  it('returns default for undefined', () => {
    expect(getStatusColor(undefined)).toMatch(/bg-gray/);
  });

  it('returns default for empty string', () => {
    expect(getStatusColor('')).toMatch(/bg-gray/);
  });
});
