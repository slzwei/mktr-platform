...
function defineAssociations() {
  const {
    ...
    LeadPackage, LeadPackageAssignment, Payment, CampaignPreview,
    QrScan, Attribution, SessionVisit, ProspectActivity,
    ShortLink, ShortLinkClick,
    WebhookSubscriber, WebhookDelivery, AgentGroup,
    AgentGroupMember,
    CampaignAgentAssignment, ExternalAgent, ExternalCampaignAgent,
    WalletLedger
  } = models;
...
export const {
  ...
  LeadPackage, LeadPackageAssignment, Payment, CampaignPreview,
  QrScan, Attribution, SessionVisit, ProspectActivity,
  IdempotencyKey, ShortLink,
  ShortLinkClick, RoundRobinCursor, Verification, PhoneVerificationMarker,
  WebhookSubscriber, WebhookDelivery, AgentGroup,
  AgentGroupMember,
  CampaignAgentAssignment, ExternalAgent, ExternalCampaignAgent,
  ...
  RedemptionEvent, RedeemOpsCategory, DiscoveryDailyUsage,
