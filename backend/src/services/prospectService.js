...
import { makeProspectMutationOps } from './prospectMutationService.js';
import {
  UUID_RE,
...
export function makeProspectService(overrides = {}) {
  ...
  const mutations = makeProspectMutationOps({ d, m });
  const { updateProspect, deleteProspect, scheduleFollowUp, bulkDeleteProspects } = mutations;
