...
- NEVER end a script with a sign-off or signature ("Best regards", a name line, etc.) — the platform appends the sender's own signature automatically when an email goes out. End on the question or call to action.
